...
public class CurrencyOld {
	...
	public CurrencyOld(String nameValue, String shortNameValue) {
		this.name = nameValue;
	...
	public static ArrayList<CurrencyOld> init() {
		ArrayList<CurrencyOld> currencies = new ArrayList<CurrencyOld>();
				
		currencies.add( new CurrencyOld("US Dollar", "USD") );
		currencies.add( new CurrencyOld("Euro", "EUR") );
		currencies.add( new CurrencyOld("British Pound", "GBP") );
		currencies.add( new CurrencyOld("Swiss Franc", "CHF") );
		currencies.add( new CurrencyOld("Chinese Yuan Renminbi", "CNY") );
		currencies.add( new CurrencyOld("Japanese Yen", "JPY") );
